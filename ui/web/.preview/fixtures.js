...
export default {
  ...
  window: {
    fetchNavigation: async () => [
      ...
      { title: "Your Agents", url: "/agents.html?view=your-agents", icon: "user" },
      { title: "Add Agent", url: "/agents.html?view=import", icon: "plus" },
      { title: "Sessions", url: "/sessions.html", icon: "clock" },
      { title: "MCP gateway", url: "/mcp.html", icon: "server" },
      { title: "Flows", url: "/sessions.html?view=flows", icon: "cornerUpRight" },
      { title: "Builds", url: "/agents.html?view=builds", icon: "cube" },
      { title: "TokenOps", url: "/tokenops.html", icon: "coins" },
      { title: "Secrets", url: "/settings.html?view=secrets", icon: "lock" },
