...
export const icons = {
  ...
  // Lucide-style additions for the nav (bot/server/route/coins/workflow)
  ...
  banknote: s(`<rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01"/><path d="M18 12h.01"/>`),
