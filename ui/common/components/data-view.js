...
styles.replaceSync(`@scope (data-view) {
    :scope {
      display: flex;
    ...
    .search {
      ...
      &:focus { border-color: var(--color-primary); box-shadow: 0 0 0 3px var(--color-primary-ring); }
    ...
    .items {
      ...
      &.is-grid {
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(var(--pl-col-min, 380px), 1fr));
      }
    }
    .pl-skeleton-card {
      border: 1px solid var(--color-border);
    ...
    .page-btn {
      ...
      &:focus-visible { box-shadow: 0 0 0 3px var(--color-primary-ring); }
    }
    .page-info {
      font-size: var(--font-size-sm);
      color: var(--color-text-muted);
