use nasiko_utils::{env_or, env_parse, required_env, env_template};
...
impl Config {
    pub fn from_env() -> anyhow::Result<Self> {
        Ok(Self {
            ...
            ssh_key_path: env_or("SSH_KEY_PATH", "/root/.ssh/id_ed25519"),
    ...
    pub fn template() -> String {
        env_template! {
            ...
            "CP_DOMAIN" => optional; "Domain for ACME TLS",
            "DATABASE_URL" => required; "Postgres connection string",
            "REDIS_URL" => required; "Redis connection string",
            "SCHEDULER_MODE" => "local"; "Orchestrator: local, mini, kubernetes",
            "S3_ENDPOINT" => "http://localhost:9000"; "S3-compatible endpoint",
            "S3_BUCKET" => "nasiko"; "S3 bucket name",
            "S3_ACCESS_KEY" => "nasiko"; "S3 access key",
            "S3_SECRET_KEY" => required; "S3 secret key",
            "S3_REGION" => "us-east-1"; "S3 region",
            "SECRETS_ENCRYPTION_KEY" => required; "AES-256-GCM key for user secrets (32 chars)",
            "SEED_AGENTS" => optional; "Space-separated seed agent images",
            "OPENAI_API_KEY" => optional; "OpenAI/DeepSeek API key",
            "OPENAI_BASE_URL" => optional; "LLM base URL",
            "OPENAI_MODEL" => "deepseek-v4-flash"; "Default model for agents",
            "ROUTER_MODEL" => "deepseek-v4-pro"; "Model for router agent selection",
            "OTEL_EXPORTER_OTLP_ENDPOINT" => optional; "OTLP endpoint (enables telemetry)",
            "NASIKO_FLOW_MAX_DEPTH" => "5"; "Max agent-to-agent call depth",
            "NASIKO_FLOW_MAX_FAN_OUT" => "20"; "Max invocations per flow",
            "NASIKO_FLOW_MAX_TOKENS" => "100000"; "Max tokens per flow",
            "NASIKO_FLOW_TIMEOUT_SECS" => "120"; "Flow timeout (seconds)"
        }
    }
}
