...
class RegistryManager:
    ...
    def update_agent_registry(self, agent_folder_name, action="upsert", owner_id=None):
        ...
        """
        # Look for AgentCard.json (generated by agentcard_generator) or mcp_manifest.json
        agentcard_path = self.agents_dir / agent_folder_name / "AgentCard.json"
        mcp_manifest_path = self.agents_dir / agent_folder_name / "mcp_manifest.json"
        ...
        try:
            target_path = agentcard_path if agentcard_path.exists() else mcp_manifest_path
